...
void ParticleSystem::Emit(const ParticleProps& particleProps) {
  ...
  // Color
  particle.color_begin = particleProps.ColorBegin;
  particle.color_end = particleProps.ColorEnd;

  particle.life_time = particleProps.LifeTime;
  particle.life_remaining = particleProps.LifeTime;
  particle.size_begin =
      particleProps.SizeBegin + particleProps.SizeVariation * (Random::Float() - 0.5f);
  particle.size_end = particleProps.SizeEnd;
